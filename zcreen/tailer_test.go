...
func TestTailer_GetReadOnlyAsyncScreen(t *testing.T) {
...
func TestTailer_BasicOut(t *testing.T) {
...
func TestTailer_MultiplePrinters(t *testing.T) {
...
func TestTailer_MultipleSessions(t *testing.T) {
...
func TestTailer_Notifications(t *testing.T) {
...
func TestTailer_TailBlocking_InOrder(t *testing.T) {
...
func TestTailer_TailBlocking_ClearedSession(t *testing.T) {
...
func TestTailer_TailBlocking_InParallel(t *testing.T) {
...
func TestTailer_TailBlocking_ContinuousFlow(t *testing.T) {
...
func TestTailer_TailBlocking_OutOfOrder(t *testing.T) {
...
func TestTailer_TailAllBlocking_InOrder(t *testing.T) {
...
func TestTailer_TailAllBlocking_ClearedSession(t *testing.T) {
	tmpDir := "/tmp/utilz.zcreen.foo9002d"
	require.NoError(t, os.RemoveAll(tmpDir))
	screen := NewAsyncScreen(tmpDir, false)
	require.NotNil(t, screen)

	expectedSession := "foo9002"
	expectedPrinter := "bar"
	expectedMessage := "baz"
...
func TestTailer_TailSuppliedBlocking_InOrder(t *testing.T) {
	...
	expectedSessionA := "barA9003"
	expectedPrinterA10a := "barA10a"
	expectedPrinterA20a := "barA20a"
	expectedSessionB := "barB9003"
	expectedPrinterB10a := "barB10a"
	expectedPrinterB30a := "barB30a"
	expectedSessionC := "barC9003"
	expectedPrinterC10a := "barC10a"
	expectedPrinterC30a := "barC30a"
	expectedPrinterC40a := "barC40a"
